...
namespace DataAccess.Repository
{
    public class OrderRepository : IOrderRepository
    {
        ...
        public Task<IEnumerable<OrderDTO>> GetOrderCookingAsync() => OrderDAO.Instance.GetOrderByStatusAsync(new Guid("4F716054-4241-4A5C-A484-9CCF9705D3B0"));

        public Task<IEnumerable<OrderDTO>> GetOrderFinishAsync() => OrderDAO.Instance.GetOrderByStatusAsync(new Guid("5E1BDE6C-589F-413C-807C-A36E6C64A090"));

        public Task<IEnumerable<OrderDTO>> GetOrderPendingAsync() => OrderDAO.Instance.GetOrderByStatusAsync(new Guid("DE3E4850-B990-4D62-BA90-4BBB49506722"));

        public Task<IEnumerable<OrderDTO>> GetOrderDeliveringAsync() => OrderDAO.Instance.GetOrderByStatusAsync(new Guid("ECDB311C-0C0B-46AB-91D3-9F44F0C86FA5"));
        ...
        public Task<IEnumerable<OrderDTO>> GetOrdersAsync() => OrderDAO.Instance.GetOrdersAsync();
    }
}
